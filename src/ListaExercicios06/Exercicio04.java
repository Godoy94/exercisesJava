...
public class Exercicio04 {
    public static void main(String[] args) {
        ...
        float valorNota01 = scanner.nextFloat();
        System.out.print("Digite o Valor da segunda Nota: ");
        float valorNota02 = scanner.nextFloat();
        System.out.print("Digite o Valor da Terceira Nota: ");
        float valorNota03 = scanner.nextFloat();
        System.out.print("Digite o Valor da Quarta Nota: ");
        float valorNota04 = scanner.nextFloat();
        float valorNotaFinal = (valorNota01 + valorNota02 + valorNota03 + valorNota04) / 4;
        if (valorNotaFinal >= 7) {
            System.out.print("O aluno foi APROVADO sem Exame com a MEDIA: " + valorNotaFinal);
        } else if (valorNotaFinal < 7) {
            System.out.print("Digite o Valor da Nota do EXAME: ");
            float valorNotaExame = scanner.nextFloat();
            float valorNotaFinalComExame = (valorNotaFinal + valorNotaExame) / 2;
            System.out.print("Media do aluno com o exame: " + valorNotaFinalComExame);
            if (valorNotaFinalComExame >= 5) {
                System.out.print("O aluno Foi APROVADO com a Media do Exame: " + valorNotaFinalComExame);
            } else {
                System.out.print("O aluno foi REPROVADO mesmo com a MEDIA do exame: " + valorNotaFinalComExame);
            }
        }
