...
public class Exercicio1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("O resultado da soma de A + B = " + adicaoAB + " o resultado da soma de A + C = " + adicaoAC
        ...
        System.out.print("O resultado da soma de B + A = " + adicaoBA + " o resultado da soma de B + C = " + adicaoBC
